...
{
    public partial class StdntForgotPassword : Form
    {
        public StdntForgotPassword()
        {
            InitializeComponent();
        }
        ...
        private void BtnSend_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Select * from tbl_Stdnt where SUsername=@p1 and SMail=@p2", con.bgl());
                ...
                if (dr.Read())
                {
                    ...
                    string from = "isteproje31@gmail.com";
                    ...
                    smtpClient.Credentials = new NetworkCredential(from, "iste182503");
                    smtpClient.Send(sms);
